...
export const useSousUnstake = (sousId) => {
  ...
  const handleUnstake = useCallback(
    async (amount: string, decimals: number) => {
      ...
      dispatch(updateUserStakedBalance(sousId, account as string))
      dispatch(updateUserBalance(sousId, account as string))
      dispatch(updateUserPendingReward(sousId, account as string))
    },
